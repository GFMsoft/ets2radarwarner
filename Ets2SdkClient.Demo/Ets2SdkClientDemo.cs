        ...
        private void Telemetry_Data(Ets2Telemetry data, bool updated)
        {
            try
            {
                ...
                foreach (var grp in grps)
                {
                    ...
                    testx = data.Physics.CoordinateX;
                    string_x = testx.ToString();

                    testz = data.Physics.CoordinateZ;
                    string_z = testz.ToString();


                    textBox_x.Text=string_x;
                    textBox_z.Text = string_z;
